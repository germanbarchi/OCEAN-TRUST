...
results_path = os.path.join('results/TrustV2_results/data',exp_name)
...
feature_list=['egemaps+sr_free/TrustV2_free-egemaps+sr-full_audio.csv',
        'egemaps+sr_lecture/TrustV2_lecture-egemaps+sr-full_audio.csv']
...
egemaps_sr=egemaps.copy()
egemaps_sr.append('speech_ratio')

feature_tags={'egemaps':egemaps,'egemaps+sr':egemaps_sr}
...
for feat in features:
    features_and_filters.append((feat,lists_))
