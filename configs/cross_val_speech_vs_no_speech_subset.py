...
labels_path='data/labels/first_impressions_parts-no_speech_subset-20_groups-5_folds.csv'
...
lists=['data/lists/silero_th_0.5_no_speech.txt','data/lists/all_audio_complete_set.txt']
