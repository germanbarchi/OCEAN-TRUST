...
python extract_egemaps.py ../data/features/egemaps_normalized_s.csv --files_path ../data/silero/silero_speech --normalize True
python extract_egemaps.py ../data/features/egemaps_normalized_ns.csv --files_path ../data/silero/silero_no_speech --normalize True
